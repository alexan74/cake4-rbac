<div class="well">
    ...
    <div class="col-sm-10">       
        <form accept-charset="utf-8" class="form-horizontal" id="RbacUsuarioEditForm" name="RbacUsuarioEditForm" role="form" action="/Usuarios/editar/<?php echo $rbacUsuario->id; ?>" method="POST">          
            ...
            <div class="form-group">                                        
                ...
                <label for="rbac-perfiles-ids" class="col-sm-3 control-label">Perfil</label>                                
                 <div class="col-sm-5">                                        
                    <select required="required" id="rbac-perfiles-ids" name="rbac_perfiles[_ids][]" class="form-control" multiple="multiple" <?php if ($perfilDefault==5) echo " disabled ";?>>
            ...
            <div class="form-group">                                                            
                <label for="RbacUsuarioPerfilDefault" class="col-sm-3 control-label">Perfil Default</label>
                 <div class="col-sm-5">
                    <select required="required" id="RbacUsuarioPerfilDefault" name="perfil_default_id" class="form-control" <?php if ($perfilDefault==5) echo " disabled ";?>>   
