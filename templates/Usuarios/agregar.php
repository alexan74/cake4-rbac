<div class="well">
	...
	<div class="col-md-10">        
	 	<form class="form-horizontal" id="RbacUsuariosAddForm" name="RbacUsuariosAddForm" role="form" action="/usuarios/agregar/" method="POST">
	        <div class="form-group form-inline ldap">
	            <label for="valida_ldap" class="col-sm-3 control-label">Tipo de Usuario</label>
	            <div class="col-sm-9">                                            
	                <div class="radio">
	                    <label>
	                      <input type="radio" name="valida_ldap" id="optionsRadios" onclick="validaLdap(true)" value="1" checked>
	                      Usuario Interno (Trigrama) 
	                    </label>
	                </div>
	                <div class="radio" style="margin:0 30px;"></div>
	                <div class="radio">
	                    <label>
