...
<section id="layout">
  ...
  <div class="callout callout-danger lead">
    <h4>Tip!</h4>
    <p>The <a href="<?php echo $this->Url->build('/pages/starter'); ?>">starter page</a> is a good place to start building your app if you'd like to start from scratch.</p>
  </div>
        ...
        <div class="box-body">
          ...
          <div class="direct-chat-contacts">
            <ul class="contacts-list">
              <li>
                <a href="#">
                  <?php echo $this->Html->image('user1-128x128.jpg', array('class' => 'contacts-list-img', 'alt' => 'Contact Avatar')); ?>
        ...
        <div class="box-body">
          ...
          <div class="direct-chat-contacts">
            <ul class="contacts-list">
              <li>
                <a href="#">
                  <?php echo $this->Html->image('user1-128x128.jpg', array('class' => 'contacts-list-img', 'alt' => 'Contacts Avatar')); ?>
                  <div class="contacts-list-info">
                    <span class="contacts-list-name">
                      Count Dracula
                      <small class="contacts-list-date pull-right">2/28/2015</small>
        ...
        <div class="box-body">
          ...
          <div class="direct-chat-contacts">
            <ul class="contacts-list">
              <li>
                <a href="#">
                  <?php echo $this->Html->image('user1-128x128.jpg', array('class' => 'contacts-list-img', 'alt' => 'Conacts Avatar')); ?>
                  <div class="contacts-list-info">
                    <span class="contacts-list-name">
                      Count Dracula
                      <small class="contacts-list-date pull-right">2/28/2015</small>
